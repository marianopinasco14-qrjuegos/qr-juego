    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-gray-900 border border-white/10 rounded-2xl p-6 min-h-64">
        ...
        {step===3&&<div className="space-y-4">
          <div className="flex items-center justify-between"><label className="text-white font-medium">Premios</label>{form.gameType!=="RASCA_Y_GANA"&&form.gameType!=="SLOTS"&&<button type="button" onClick={()=>upd({prizes:[...form.prizes,{title:"",stock:10,priority:5,frequency:50,validDays:30}]})} className="text-violet-400 text-sm">+ Agregar</button>}</div>
