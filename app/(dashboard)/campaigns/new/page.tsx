...
const GAMES=[{id:"RASCA_Y_GANA",label:"Rasca y Gana",emoji:"🎫",desc:"Tarjeta táctil"},{id:"SLOTS",label:"Tragamonedas",emoji:"🎰",desc:"Tres rodillos"},{id:"SORTEO",label:"Sorteo",emoji:"🎲",desc:"Sorteo con fecha de cierre"},{id:"GLOBO",label:"Explota el Globo",emoji:"🎈",desc:"Explotá el globo y descubrí tu premio"},{id:"CAJA",label:"Elige tu Número",emoji:"🔢",desc:"Elegí tu número de la suerte y descubrí tu premio"}];
